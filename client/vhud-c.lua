...
RegisterNetEvent('qb-hud:nitro')
AddEventHandler('qb-hud:nitro', function(percent)
  nitro = percent
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(player, false) then
			...
			if IsControlJustReleased(0, 47) and (has_value(vehiclesCars, vehicleClass) == true and vehicleClass ~= 8) then
